...
async def on_ready():
    ...
    stream2 = discord.Streaming(assets=assets2, name="BOT BY $HIKI", details="Bot made for the Babi Discord server.", url="https://discord.gg/Qqzy2ds", game="Bot made for the Babi Discord server.")    while True:
